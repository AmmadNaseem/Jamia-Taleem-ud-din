    ...
    <section class="banner">
      <div class="banner-box">
        <div class="intro-textAll">
            <h1 class="fw-bold sm-title-head text-capitalize"><strong style="color:rgb(25, 153, 5)">Contact</strong> Us</h1>
            <img src="images/banners/hero5.jpg"  alt="Contact Us">
        </div>
    ...
    <div class="container my-4">
        <div class="row my-2 py-3 shadow text-center text-sm-start">
            <div class="col-lg-4">
                ...
                <p class="fw-300">
                    <span>
                     ...
                     Address:<strong>Mandian Abbottabad</strong>
                </p>
            ...
            <div class="col-lg-4">
                <p class="fw-300">
                    ...
                    Phone:<strong>+923103223635</strong>
                </p>
            ...
            <div class="col-lg-4">
                <p class="fw-300">
                    ...
                    Email:<strong>smilefoods@gmail.com</strong></p>
        ...
        <div class="row my-5 shadow">
            <div class="col-lg-4 p-2">
                <img src="images/banners/hero6.jpg"  class="img-fluid rounded " alt="Contact Us">
            </div>
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Enter message here!" rows="5"></textarea>
                      </div>
                      <div class="mb-3">
